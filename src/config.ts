...
export const Site = 'https://midasevil.com';
export const SiteLanguage = 'zh';
export const SiteTitle = '今日做梦';
export const SiteDescription = '日拱一卒，功不唐捐';
...
export const Socials: Record<string, Record<string, string>> = {
	mail: { url: 'midasevil@gmail.com' },
	github: { url: 'https://github.com/midasnake' },
